         ...
         box(width = 12,
             tabsetPanel(type = "tabs",
                  ...
                  tabPanel("Withdrawal Parameters",
                           ...
                           div(id = "pd_annual_withdrawals_drawdown_input", numericInputIcon(inputId = "pd_annual_withdrawals_drawdown", label = "Total Withdrawals per Annum:", value = 10000, min = 0, icon = icon("euro"))),
                           ...
                           div(id = "pd_annual_withdrawals_buylater_input", numericInputIcon(inputId = "pd_annual_withdrawals_buylater", label = "Total Withdrawals per Annum:", value = 10000, min = 0, icon = icon("euro"))),
                           ...
                           div(id = "pd_annual_withdrawals_deferred_input", numericInputIcon(inputId = "pd_annual_withdrawals_deferred", label = "Total Withdrawals per Annum:", value = 10000, min = 0, icon = icon("euro"))),
