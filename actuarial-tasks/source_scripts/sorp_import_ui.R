list(
  ...
  box(
    ...
    DT::dataTableOutput("import_calcs_table"), style = "height:430px; overflow-y: scroll;overflow-x: scroll;",
    br(),
    hidden(div(id = "import_calcs_download_button", downloadButton("import_calcs_download", label = "Download Data")))
  )
)