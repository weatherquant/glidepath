list(
  ...
  sidebarLayout(
    ...
    sidebarPanel(actionButton(inputId = "drawdown_resim", label = "Re-Run Simulation", style = "background-color: white; float:right", icon("random")),
                 ...
                 numericInputIcon(inputId = "drawdown_start_capital", label = "Starting Capital:", value = 300000, min = 0, icon = icon("dollar")),
                 ...
                 div(id = "drawdown_annual_withdrawals_input", numericInputIcon(inputId = "drawdown_annual_withdrawals", label = "Total Withdrawals per Annum:", value = 12000, min = 0, icon = icon("dollar"))),
