    ...
    sidebarPanel(style = "height:737px; overflow-y:auto",
      ...
      tabsetPanel(type = "tabs",
                  tabPanel("Parameters",
                           ...
                           numericInputIcon(inputId = "sorp_salary", label = "Current Salary:", value = 50000, min = 0, icon = icon("dollar")),
                           numericInputIcon(inputId = "sorp_current_fundvalue", label = "Current Fund Value:", value = 100000, min = 0, icon = icon("dollar")),
