    ...
    sidebarPanel(style = "height:800px; overflow-y:auto",
      ...
      tabsetPanel(type = "tabs", id = "sd_sidebar",
                  tabPanel("SORP Parameters",
                           ...
                           numericInputIcon(inputId = "sd_salary", label = "Current Salary:", value = 50000, min = 0, icon = icon("dollar")),
                           numericInputIcon(inputId = "sd_current_fundvalue", label = "Current Fund Value:", value = 100000, min = 0, icon = icon("dollar")),
                  ...
                  tabPanel("Spouse SORP Parameters",
                           ...
                           br(), br(),
                           numericInputIcon(inputId = "sd_salary_spouse", label = "Current Salary:", value = 50000, min = 0, icon = icon("dollar")),
                           numericInputIcon(inputId = "sd_current_fundvalue_spouse", label = "Current Fund Value:", value = 100000, min = 0, icon = icon("dollar")),
                  ...
                  tabPanel("Drawdown Parameters",
                           ...
                           div(id = "sd_annual_withdrawals_input", numericInputIcon(inputId = "sd_annual_withdrawals", label = "Total Withdrawals per Annum:", value = 15000, min = 0, icon = icon("dollar"))),
