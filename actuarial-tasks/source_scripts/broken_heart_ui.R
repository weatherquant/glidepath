list(
  ...
  sidebarLayout(
    ...
    sidebarPanel(h3("Parameters:"),
                 ...
                 actionButton(inputId = "bh_surveydisplay", label = "Risk Profiler", style = "background-color: white", icon("poll")),
                 h6(textOutput("bh_save_results_text")),
    ...
    mainPanel(
      uiOutput("bh_ui"),
      column(1, actionButton("bh_submit", "Next"))
      # box(
